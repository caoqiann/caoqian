      ...
      <div id="dh">
        ...
        <div id="left">
          ...
          <h1></h1>
           	<div id="colee" >
<div id="colee1">
<p> <img src="{IMG_PATH}/hdschool/images/pic.gif" width="200" height="150" />2010-2011年度先进单位</p>
<p> <img src="{IMG_PATH}/hdschool/images/pic.gif" width="200" height="150" />2010-2011年度先进单位</p>
<p> <img src="{IMG_PATH}/hdschool/images/pic.gif" width="200" height="150" />2010-2011年度先进单位</p>
<p> <img src="{IMG_PATH}/hdschool/images/pic.gif" width="200" height="150" />2010-2011年度先进单位</p>
<p> <img src="{IMG_PATH}/hdschool/images/pic.gif" width="200" height="150" />2010-2011年度先进单位</p>
...
<body>
    ...
    <div id="right">
        <h1>{$title}</h1>
        <h2>作者：{$username}&nbsp;&nbsp;&nbsp;&nbsp;    图片来源：本站原创&nbsp;&nbsp;&nbsp;&nbsp;     点击数： <span id="hits"></span>&nbsp;&nbsp;&nbsp;&nbsp;     更新时间：{$updatetime}</h2>{$content}<!--
